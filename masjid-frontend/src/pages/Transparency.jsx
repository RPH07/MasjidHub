...
const Transparency = () => {
  ...
  const handleDownloadZakat = async() => {
    try {
      ...
      await transparencyService.downloadZakatPdf();
    } catch (error) {
  ...
  const handleDownloadProgramPdf = async() => {
    try {
      ...
      await transparencyService.downloadProgramPdf(selectedProgramId);
    } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchProgramTransparency = async () => {
      try {
        ...
        const data = await transparencyService.getProgram(selectedProgramId);
        setProgramData(data);
      } catch (err) {

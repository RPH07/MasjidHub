...
import DonationDetailModal from '@/features/donations/components/shared/DonationDetailModal';
...
const DonationPrograms = () => {
    ...
    const showPublicNavbar = location.pathname === '/donation-programs';
    ...
    const handleDownloadPdf = async (programId, programName) => {
        try {
            ...
            await transparencyService.downloadProgramPdf(programId);
    ...
    const handleSubmitDonasi = async (donasiData) => {
        try {
            ...
            const response = await donationService.submitDonation(donasiData);
    ...
    const handleUploadDonasiProof = async (donationId, proofFile) => {
        try {
            ...
            const response = await donationService.uploadDonationProof(donationId, proofData);

                    ...
                    <div className="hidden md:flex items-center space-x-3">
                        {user ? (
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="relative group">
                                    <button className="flex items-center space-x-2 px-4 py-2 text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200">
                                        <div className="w-8 h-8 bg-linear-to-br from-green-400 to-teal-500 rounded-full flex items-center justify-center">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <Link
                                    to="/signup"
                                    className="px-6 py-2 bg-linear-to-r from-green-500 to-teal-600 text-white font-medium rounded-lg hover:from-green-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
                                >
                                    Daftar
                                </Link>
                            </div>
                            ...
                            {user ? (
                                <div className="space-y-1">
                                    ...
                                    <div className="px-3 py-2">
                                        <div className="flex items-center space-x-3">
                                            <div className="w-10 h-10 bg-linear-to-br from-green-400 to-teal-500 rounded-full flex items-center justify-center">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Link
                                        to="/signup"
                                        onClick={() => setIsOpen(false)}
                                        className="block px-3 py-2 bg-linear-to-r from-green-500 to-teal-600 text-white text-center font-medium rounded-md hover:from-green-600 hover:to-teal-700 transition-all duration-200"
                                    >
                                        Daftar
                                    </Link>
                                </div>

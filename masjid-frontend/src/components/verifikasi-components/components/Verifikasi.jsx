import DonasiVerification from "./DonasiVerification";
        ...
        <div className="space-y-6 px-5 sm:px-0">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border bg-white p-4 shadow-sm">
                    <p className="text-sm text-gray-400">Zakat Menunggu Verifikasi</p>
                ...
                <div className="rounded-lg border bg-white p-4 shadow-sm">
                    <p className="text-sm text-gray-400">Donasi Menunggu Verifikasi</p>
                    <p className="mt-2 text-2xl font-bold text-green-700">

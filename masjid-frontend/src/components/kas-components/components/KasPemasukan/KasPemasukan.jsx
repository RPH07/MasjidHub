            ...
            <tbody className="divide-y divide-gray-200">
              ...
              {zakatData.map((item) => (
                <tr key={`zakat-${item.id}`}>
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-green-600">{formatCurrency(item.jumlah)}</td>
        ...
        {zakatData.map((item) => (
          <div key={`zakat-mobile-${item.id}`} className="bg-white border rounded-lg p-4 shadow-sm">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="text-lg font-medium text-green-600">{formatCurrency(item.jumlah)}</div>
            </div>

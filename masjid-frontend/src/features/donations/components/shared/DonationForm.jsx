        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <FloatingInput
                    ...
                    inputClassName={errors.nama_donatur ? 'border-red-500 focus:ring-green-500' : 'border-gray-300 focus:ring-green-500'}
            ...
            <div>
                <FloatingInput
                    ...
                    onChange={handleInputChange}
                    min="10000"
                    inputClassName={errors.nominal_donasi ? 'border-red-500 focus:ring-green-500' : 'border-gray-300 focus:ring-green-500'}
                    labelFocusClass="peer-focus:text-green-600"
                    required
                />

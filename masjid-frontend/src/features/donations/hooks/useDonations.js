...
export const useDonations = () => {
    ...
    const fetchProgramDonasi = useCallback(async () => {
        try {
            ...
            const response = await donationService.getPrograms();
            setState(prev => ({
                ...prev,
    ...
    const fetchProgramAktif = useCallback(async () => {
        try {
            setState(prev => ({ ...prev, loading: true, error: null }));
            const response = await donationService.getActivePrograms();
            setState(prev => ({
                ...prev,
    ...
    const createProgramDonasi = useCallback(async (formData, file) => {
        try {
            ...
            const response = await donationService.createProgram(form);
    ...
    const updateProgramDonasi = useCallback(async (id, formData, file) => {
        try {
            ...
            const response = await donationService.updateProgram(id, updateData);
    ...
    const deleteProgramDonasi = useCallback(async (id) => {
        try {
            ...
            const response = await donationService.deleteProgram(id);
    ...
    const activateProgram = useCallback(async (id) => {
        try {
            const response = await donationService.activateProgram(id);
            return { 
                success: true, 
    ...
    const deactivateProgram = useCallback(async (id) => {
        try {
            const response = await donationService.deactivateProgram(id);
            return { 
                success: true, 
    ...
    const completeProgram = useCallback(async (id) => {
        try {
            const response = await donationService.completeProgram(id);
            return { 
                success: true, 
